...
<head>
    ...
    <!-- Favicons -->
    <link rel="icon" href="images/favicon-1.png " sizes="32x32" type="image/png">
    ...
    <main>
        <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
            <div class="col-md-5 p-lg-5 mx-auto my-5">
                <h1 class="display-4 fw-normal">Yes Chat</h1>
                <p class="lead fw-normal">Chat with your friends without worrying about the chat logs.Now you can freely
                    chat with your friends using our free platform.</p>
                <form action="claim.php" method="post">
                    Yes chat.com/ <input type="text" name="room">
